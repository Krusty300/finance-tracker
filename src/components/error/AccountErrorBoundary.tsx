        ...
        <Card className="border-destructive/50 bg-destructive/5">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Something went wrong while loading account data. This might be due to invalid account data or a temporary issue.
            </p>
...
export function AccountErrorFallback({ error, reset }: { error?: Error; reset: () => void }) {
  return (
    <Card className="border-destructive/50 bg-destructive/5">
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-muted-foreground">
          There was an error processing account data. This could be due to corrupted account information or invalid balance calculations.
        </p>
